...
<html>
    ...
    <body>
        <form method="get">
            ...
            <input id="childName" type="submit" name="childName" value="Petyrcho"/><br/>
            <label for="wantedPresent">Wanted Present</label><br/>
            <input id="wantedPresent" type="submit" name="wantedPresent" value="Big Truck" /> <br/>
            ...
            <input type="submit" name ="submit" value="Send" autofocus="autofocus"/>
        </form>
